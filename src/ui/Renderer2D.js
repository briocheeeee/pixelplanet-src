...
class Renderer2D extends Renderer {
  ...
  renderPixel(
    ...
    const colorStr = (palette && Array.isArray(palette.colors))
      ? palette.colors[(Number.isFinite(color) ? (color | 0) : -1)]
      : undefined;
    if (typeof context.fillRect === 'function' && typeof colorStr === 'string') {
